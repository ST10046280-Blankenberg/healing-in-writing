...
using HealingInWriting.Repositories.Terms;
...
builder.Services.AddScoped<ITermsOfServiceRepository, TermsOfServiceRepository>();
builder.Services.AddScoped<ITermsOfServiceService, TermsOfServiceService>();
